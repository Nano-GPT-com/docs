...
<AccordionGroup>
  <Accordion icon="message-bot" title="Text Generation">
    ...
    For more detailed examples and other text generation endpoints, check out our [Text Generation Guide](/text-generation).
  </Accordion>
  ...
  <Accordion icon="image" title="Image Generation">
    ...
    For more detailed examples and other image generation options, check out our [Image Generation Guide](/image-generation).
  </Accordion>
</AccordionGroup>
