...
For selected endpoints, you can also use [Accountless x402 API Payments](/api-reference/miscellaneous/x402) to receive a payment quote without an account or API key. Check `GET /api/v1/x402/endpoints` for the current supported matrix.
