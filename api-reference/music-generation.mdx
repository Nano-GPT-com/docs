...
Music model availability changes over time. Discover available audio models via `GET https://nano-gpt.com/api/v1/audio-models` (see [Audio Models](/api-reference/endpoint/audio-models)) and select a model intended for music generation.
