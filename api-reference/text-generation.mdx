...
Here are the available text generation models and their pricing:

| Name | Input Rate (per 1M tokens) | Output Rate (per 1M tokens) | Model | Description |
|------|----------------------------|-----------------------------|-------|-------------|
| GPT-4 Turbo | $0.01 | $0.03 | gpt-4-turbo-preview | Latest GPT-4 model with improved performance |
| GPT-3.5 Turbo | $0.0015 | $0.002 | gpt-3.5-turbo | Fast and efficient model for most tasks |
| Claude 3 Opus | $0.015 | $0.075 | claude-3-opus-20240229 | Anthropic's most capable model |
| Claude 3 Sonnet | $0.003 | $0.015 | claude-3-sonnet-20240229 | Balanced performance and cost |
| Claude 3 Haiku | $0.00025 | $0.00125 | claude-3-haiku-20240307 | Fastest Claude model for simple tasks | 