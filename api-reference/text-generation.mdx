...
Brave also offers an LLM Context API (relevance-ranked smart chunks optimized for LLM consumption). NanoGPT does not currently integrate that API surface.
