...
- **`brave`**: Brave Grounding. Performs a single web search and generates a grounded answer. Fast responses (often ~4-5 seconds) and typically low cost. Good for quick factual questions.
- **`brave-pro`**: Brave Pro Grounding. Premium tier with higher quality answers, more search depth, and priority processing.
- **`brave-research`**: Brave Research. Performs multiple iterative searches with reasoning and planning for thorough answers. Response times can extend to minutes. Best for complex questions that need deeper research.
