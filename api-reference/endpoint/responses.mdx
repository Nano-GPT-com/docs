...
| `service_tier` | string | No | Service tier: `auto`, `default`, `flex`, or `priority` |
...
1. Deep research models: Models like `o3-deep-research` and `o4-mini-deep-research` are not supported.
