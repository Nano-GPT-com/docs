...
| `research_maximum_number_of_iterations` | integer | — | — | Maximum number of research iterations (1-5). |
| `research_maximum_number_of_queries` | integer | — | — | Maximum number of search queries to issue during research (1-50). |
