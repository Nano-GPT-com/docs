...
description: "Perform AI-powered web searches using Linkup with multiple output formats"
---
...
curl -X POST https://nano-gpt.com/api/web \
  ...
  -d '{
    "query": "top tech companies by revenue",
    "outputType": "structured",
    "structuredOutputSchema": "{\"type\":\"object\",\"properties\":{\"companies\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"},\"revenue\":{\"type\":\"string\"}}}}}}"
  }'
```
