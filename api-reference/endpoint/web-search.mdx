...
The Web Search API allows you to perform AI-powered web searches across supported providers (Linkup, Tavily, Exa, Kagi, Perplexity, Valyu), returning up-to-date information from across the internet. This API supports multiple output formats, date filtering, domain filtering, and provider-specific depth modes. If `provider` is omitted, Linkup is used by default.
...
<ParamField body="provider" type="string" default="linkup">
  Search provider. Options: "linkup", "tavily", "exa", "kagi", "perplexity", "valyu"
</ParamField>
...
<ResponseField name="metadata" type="object">
  <Expandable title="metadata">
    ...
    <ResponseField name="provider" type="string">
      The provider used for the search
    </ResponseField>
