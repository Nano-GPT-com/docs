---
title: "Data API"
api: "GET https://api.nano-gpt.com/api/v1/data"
...
```text
https://api.nano-gpt.com/api/v1/data
```
  ...
  "data": [
    {
      ...
      "url": "https://api.nano-gpt.com/api/v1/data/web/search",
...
```bash
curl https://api.nano-gpt.com/api/v1/data/url/scrape \
  -H "Authorization: Bearer $NANOGPT_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -i https://api.nano-gpt.com/api/v1/data/web/search \
  -H "Content-Type: application/json" \
  -H "x-x402: true" \
  -d '{
    "query": "NanoGPT API data endpoints",
...
```bash
curl -i https://api.nano-gpt.com/api/v1/data/url/scrape \
  -H "Content-Type: application/json" \
  -H "x-x402: true" \
  -d '{
    "urls": ["https://nano-gpt.com"],
...
```bash
curl https://api.nano-gpt.com/api/v1/data/google-maps/search \
  -H "Authorization: Bearer $NANOGPT_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl "https://api.nano-gpt.com/api/v1/data/hunter/domain-search?domain=example.com" \
  -H "Authorization: Bearer $NANOGPT_API_KEY"
```

```bash
curl https://api.nano-gpt.com/api/v1/data/hunter/domain-search \
  -H "Authorization: Bearer $NANOGPT_API_KEY" \
  -H "Content-Type: application/json" \
  -d '{
    "domain": "example.com"
...
```bash
curl "https://api.nano-gpt.com/api/v1/data/x/search?query=nanogpt" \
  -H "Authorization: Bearer $NANOGPT_API_KEY"
```
...
```bash
curl -X POST "https://api.nano-gpt.com/api/v1/data/x/search?query=nanogpt" \
  -H "Authorization: Bearer $NANOGPT_API_KEY"
```
