...
Use `GET /api/v1/x402/endpoints` as the deployment source of truth, and see [Accountless x402 API Payments](/api-reference/miscellaneous/x402) for completion and polling behavior. Direct legacy routes remain available, but accountless docs prefer the public v1 data paths.
