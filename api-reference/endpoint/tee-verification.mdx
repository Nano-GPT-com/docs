---
 ...
 openapi: 'GET /v1/tee/attestation, GET /v1/tee/signature/{requestId}'
---
...
```bash
curl "https://nano-gpt.com/v1/tee/signature/{requestId}?model=TEE/hermes-3-llama-3.1-70b&signing_algo=ecdsa" \
  -H "Authorization: Bearer $API_KEY"
```
