...
| `seed` | integer | No | Optional model-specific seed that may improve reproducibility where supported. Identical results are not guaranteed. Check the selected model's `supported_parameters` metadata before using this field. |
