...
api: "POST https://api.nano-gpt.com/api/v1/messages/count_tokens"
...
```text
POST https://api.nano-gpt.com/api/v1/messages/count_tokens
```
...
```bash
curl -X POST https://api.nano-gpt.com/api/v1/messages/count_tokens \
