---
title: "Image Edits"
api: "POST https://api.nano-gpt.com/api/v1/images/edits"
...
GPT Image 2 remains the compatibility choice for requests that include a mask. For natural-language edits without a mask, use `openai/gpt-image-2.5/flare/edit` for the current everyday recommendation.
...
```bash
curl -X POST https://api.nano-gpt.com/api/v1/images/edits \
...
```bash
curl -X POST https://api.nano-gpt.com/api/v1/images/edit \
