---
title: "Audio Models"
api: "GET https://api.nano-gpt.com/api/v1/audio-models"
...
```text
GET https://api.nano-gpt.com/api/v1/audio-models
```
...
```bash
curl "https://api.nano-gpt.com/api/v1/audio-models?type=stt&detailed=true" \
