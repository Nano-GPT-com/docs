---
title: "AI Detection"
api: "POST https://api.nano-gpt.com/api/v1/ai-detection"
...
```text
POST https://api.nano-gpt.com/api/v1/ai-detection
```
...
```bash
curl -X POST https://api.nano-gpt.com/api/v1/ai-detection \
