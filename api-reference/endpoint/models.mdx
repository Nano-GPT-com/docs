...
- **OpenAI**: <code>{exampleTextModel}</code>
...
- **Zhipu GLM 4.6 / 4.7**: `z-ai/glm-4.6`, `z-ai/glm-4.6:thinking`
...
- **NousResearch Hermes 4**: `nousresearch/hermes-4-405b`, `nousresearch/hermes-4-405b:thinking`
