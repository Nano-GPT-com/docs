...
- **OpenAI**: `openai/gpt-5.2`, `openai/gpt-5.2-chat`, `openai/gpt-5.2-codex`, `openai/gpt-5.2-pro`
...
- **xAI Grok 4 / 4.1**: `x-ai/grok-4-07-09`, `x-ai/grok-4-fast`, `x-ai/grok-4-fast:thinking`, `x-ai/grok-4.1-fast-reasoning`
