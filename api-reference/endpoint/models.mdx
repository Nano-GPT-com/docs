...
- [/api/v1/image-models](/api-reference/endpoint/image-models) - List all available image generation models
- [/api/v1/video-models](/api-reference/endpoint/video-models) - List all available video generation models
- [/api/v1/audio-models](/api-reference/endpoint/audio-models) - List all available audio models (TTS, STT, music)
