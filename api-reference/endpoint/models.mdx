...
- **xAI Grok 4 / 4.1**: `grok-4-0709`, `x-ai/grok-4-07-09`, `grok-4-fast`, `x-ai/grok-4-fast:thinking`, `x-ai/grok-4.1-fast-reasoning`, `x-ai/grok-4.1-fast:thinking`
- **Moonshot Kimi K2.5**: `kimi-k2.5`, `kimi-k2.5:thinking`, `moonshotai/kimi-k2.5` (and `:thinking`)
- **Zhipu GLM 4.6 / 4.7**: `glm-4.6`, `glm-4.7` (and `:thinking`)
- **DeepSeek V3.2**: `deepseek-v3.2`, `deepseek-v3.2-thinking`, `deepseek-v3.2-speciale`, `deepseek/deepseek-v3.2:thinking`
- **Qwen3 Coder**: `qwen3-coder:480b`, `qwen3-coder-next`, `qwen/qwen3-coder-plus`, `qwen/qwen3-coder-flash`
- **NousResearch Hermes 4**: `nousresearch/hermes-4-405b` (and `:thinking`), `nousresearch/hermes-4-70b`

Brave-powered Answers models (search + answer) are also available:
...
For Brave-specific fields, examples, pricing details, and terms highlights, see [Brave](/api-reference/miscellaneous/brave).
