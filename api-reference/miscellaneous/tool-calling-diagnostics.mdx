...
3. Review and acknowledge what may be stored.
...
The text must match exactly after trimming surrounding whitespace. It is case-sensitive and should not include any other words.
