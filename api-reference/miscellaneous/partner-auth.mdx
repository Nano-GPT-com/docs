...
Partner Auth lets your backend authenticate one of your users to NanoGPT without giving you a NanoGPT `sessionUUID` or a NanoGPT API key.
...
The response includes the linked user's balance and deposit details. It does not include `sessionUUID`.
