...
Use [`GET /api/v1/agent-capabilities`](https://api.nano-gpt.com/api/v1/agent-capabilities) and inspect `toolSearch` for the current public contract, aliases, API support, and limits. Model support is still evaluated per request.
