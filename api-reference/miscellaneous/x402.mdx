...
As of 2026-06-09, production advertises `x402-solana-usdc` on the public endpoints listed below. Continue to use `GET /api/v1/x402/endpoints` as the source of truth because enabled rails can be deployment-gated.
...
Lightning/L402 and Solana USDT are not currently advertised by NanoGPT 402 responses. Native SOL is not a documented x402 exact rail. Do not list any of them as supported accountless x402 schemes.
