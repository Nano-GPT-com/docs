...
3. Set up popular models like Claude Sonnet 5, Claude Opus 5.5, {exampleTextModelName}, Gemini Flash Latest, Gemini Pro Latest, GLM 5.3
...
| `nano-gpt/anthropic/claude-opus-5.5` | Claude Opus 5.5 |
...
| `nano-gpt/google/gemini-flash-latest` | Gemini Flash Latest |
| `nano-gpt/google/gemini-3.1-pro-preview` | Gemini Pro Latest |
