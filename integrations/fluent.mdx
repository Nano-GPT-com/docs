...
<img src="/images/integrations/fluent-models.png" alt="NanoGPT selected as a partner model provider in Fluent" style={{ borderRadius: '0.5rem' }} />
...
<img src="/images/integrations/fluent-mcp.png" alt="NanoGPT MCP configured as a Fluent integration" style={{ borderRadius: '0.5rem' }} />
