    ...
    <Tabs>
      <Tab title="One-Click Setup (Mac/Linux)">
        ...
        ```json
        {
          "env": {
            ...
            "ANTHROPIC_BASE_URL": "https://api.nano-gpt.com/api/v1",
      ...
      <Tab title="Manual Configuration (All Platforms)">
        ...
        **Windows Cmd**:
        ...
        setx ANTHROPIC_BASE_URL https://api.nano-gpt.com/api/v1
        ```
        ...
        **Windows PowerShell**:
        ...
        [System.Environment]::SetEnvironmentVariable('ANTHROPIC_BASE_URL', 'https://api.nano-gpt.com/api/v1', 'User')
        ```
...
```json
{
  "env": {
    "ANTHROPIC_AUTH_TOKEN": "your_nanogpt_api_key",
    "ANTHROPIC_BASE_URL": "https://api.nano-gpt.com/api/v1",
    "ANTHROPIC_DEFAULT_SONNET_MODEL": "{{example-text-model}}",
    "ANTHROPIC_DEFAULT_OPUS_MODEL": "anthropic/claude-opus-5.5",
    "ANTHROPIC_DEFAULT_HAIKU_MODEL": "google/gemini-flash-latest"
  }
}
```
...
|----------|-------------------|
| Best overall | <code>{exampleTextModel}</code>, `anthropic/claude-opus-5.5` |
| Fast/cheap | `google/gemini-flash-latest` |
