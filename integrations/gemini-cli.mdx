  ...
  <Step title="Set Environment Variables">
    ...
    <Tabs>
      <Tab title="macOS/Linux">
        ```bash
        export OPENROUTER_BASE_URL="https://api.nano-gpt.com/api/v1"
      ...
      <Tab title="Windows PowerShell">
        ```powershell
        $env:OPENROUTER_BASE_URL = "https://api.nano-gpt.com/api/v1"
    ...
    ```bash
    echo 'export OPENROUTER_BASE_URL="https://api.nano-gpt.com/api/v1"' >> ~/.zshrc
...
| `Connection refused` | Verify `OPENROUTER_BASE_URL` is set to `https://api.nano-gpt.com/api/v1` |
