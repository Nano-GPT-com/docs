...
> Use OpenAI's Codex CLI with NanoGPT to access GPT-5.2, o1, Claude, and 400+ AI models through a single API key.
...
- Access OpenAI models (GPT-5.2, o1, o3) without a separate OpenAI account
- Route to 400+ other models including Claude, Gemini, DeepSeek, and more
...
| Complex reasoning | `o1` | `model = "o1"` |
| Latest reasoning | `o3` | `model = "o3"` |
| Cost-effective | `deepseek-chat` | `model = "deepseek-chat"` |

View all available models at [nano-gpt.com/models](https://nano-gpt.com/models).
