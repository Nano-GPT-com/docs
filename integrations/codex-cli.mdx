...
> Use OpenAI's Codex CLI with NanoGPT to access GPT 5.6 Sol, Claude Opus 5, Gemini Flash Latest, and 400+ AI models through a single API key.
...
- Route to 400+ other models including Claude Opus 5, Gemini Flash Latest, and GLM Latest
...
| Best Claude | `anthropic/claude-opus-5` | `model = "anthropic/claude-opus-5"` |
