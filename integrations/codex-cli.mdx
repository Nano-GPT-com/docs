...
> Use OpenAI's Codex CLI with NanoGPT to access GPT-5.2, Claude Opus 5, Gemini 3.7 Flash, and 400+ AI models through a single API key.
...
- Route to 400+ other models including Claude Opus 5, Gemini 3.7 Flash, and GLM 4.7
...
| Fast/cheap | `google/gemini-3.7-flash` | `model = "google/gemini-3.7-flash"` |
