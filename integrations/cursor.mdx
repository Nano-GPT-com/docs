...
That's it! You can now use any of our models in Cursor. Available models include {exampleTextModel}, anthropic/claude-opus-5, google/gemini-3.7-flash, and many more.
